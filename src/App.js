	...
	useEffect(() => {
		...
		d3.csv(csv_data).then(d => {
			...
			if (d.length) {
				...
				names.subject_sex = "Sexo_Sujeito"
				names.nature = "Natureza"
				names.dimension = "Dimensão"
				names.anatomical_part = "Anatomia"
				names.organs = "Órgãos"
				names.subject_qualities = "Qualificativo_Sujeito"
				names.action = "Ação"
				...
				names.with_name = "Nome_Com_Quem"
				names.with_sex = "Sexo_Com_Quem"
				names.with_qualities = "Qualificativo_Com_Quem"
				names.about_name = "Nome_Sobre_Quem"
				names.about_sex = "Sexo_Sobre_Quem"
				names.about_qualities = "Qualificativo_Sobre_Quem"
				names.object = "Objeto"
				names.value = "Valor"
